...
ScreenWindow::ScreenWindow(int mode, std::vector<std::string> _teamNames, QWidget *parent) :QMainWindow(parent), teamNames(_teamNames)
{
	...
	QPixmap qpix(QString::fromLocal8Bit("data/bgi.png"));
	ui->bgi->setPixmap(qpix);

	setMap();

	ui->RegistrationCompetionName->setText(QString::fromLocal8Bit(QByteArray("比赛还未正式开始")));
}
...
void ScreenWindow::setLoad(const std::string &loanding)
{
	ui->RegistrationCompetionName->setText(QString::fromLocal8Bit(QByteArray(loanding.c_str())));
}
...
void ScreenWindow::setMap(void)
{
	...
	classes[4] = ui->Line4Class;
	classes[5] = ui->Line5Class;
	classes[6] = ui->Line6Class;
	classes[7] = ui->Line7Class;
	classes[8] = ui->Line8Class;
	classes[9] = ui->Line9Class;

	grades[0] = ui->Line0Grade;
	grades[1] = ui->Line1Grade;
	grades[2] = ui->Line2Grade;
	grades[3] = ui->Line3Grade;
	grades[4] = ui->Line4Grade;
	grades[5] = ui->Line5Grade;
	grades[6] = ui->Line6Grade;
	grades[7] = ui->Line7Grade;
	grades[8] = ui->Line8Grade;
	grades[9] = ui->Line9Grade;	

	ranks[0] = ui->Line0Rank;
	ranks[1] = ui->Line1Rank;
	ranks[2] = ui->Line2Rank;
	ranks[3] = ui->Line3Rank;
	ranks[4] = ui->Line4Rank;
	ranks[5] = ui->Line5Rank;
	ranks[6] = ui->Line6Rank;
	ranks[7] = ui->Line7Rank;
	ranks[8] = ui->Line8Rank;
	ranks[9] = ui->Line9Rank;
}